...
export const PROFILE: ProfileData = {
  ...
  projects: [
    {
      title: "Research on Team Cognitive Diagnostic Paradigm",
      role: "Major Participant",
      description: "Tool Development, Model Construction, and Grouping Algorithm Design. Ministry of Education Humanities and Social Sciences Planning Fund.",
      funding: "Funding Number: 24YJA190019",
      duration: "Jan 2025 - Dec 2027"
    },
    {
      title: "Research on Measuring Paradigm of Cooperation Ability",
      role: "Major Participant",
      description: "Tool Development and Computational Modeling by Introducing Inter-brain Neural Synchrony. Zhejiang Province Major Project in Philosophy and Social Sciences.",
      funding: "Funding Number: 25QNYC010ZD",
      duration: "Jan 2025 - Dec 2027"
    }
  ],
  workshops: [
